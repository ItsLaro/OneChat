package com.parselab.simplechat;
...
import com.parselab.simplechat.databinding.ActivityChatBinding;

import java.util.ArrayList;
import java.util.List;

public class ChatActivity extends AppCompatActivity {
    static final private String TAG = ChatActivity.class.getSimpleName();

    static final int MAX_CHAT_MESSAGES_TO_SHOW = 50;

    static final private String USER_ID_KEY = "userId";
    static final private String BODY_KEY = "body";
